...
CREATE TABLE `dev_schema`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `schema_group_id` bigint NULL DEFAULT NULL COMMENT '分组ID',
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '数据模型表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `dev_schema_field`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `schema_id` bigint NULL DEFAULT NULL COMMENT '模型ID',
  ...
  `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '数据模型字段表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '图谱构建任务表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `graph_query_history`  (
  ...
  INDEX `idx_knowledge_id`(`knowledge_id` ASC) USING BTREE,
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '图谱查询历史表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '图谱统计信息表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `knowledge_base_graph_segment`  (
  ...
  INDEX `idx_user_id`(`user_id` ASC) USING BTREE,
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '知识图谱片段表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '知识图谱实例表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `knowledge_info`  (
  ...
  `embedding_model_id` bigint NULL DEFAULT NULL COMMENT '模型id',
  `system_prompt` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '系统提示词',
  `create_dept` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '部门',
  `create_by` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
...
-- ----------------------------
INSERT INTO `sys_logininfor` VALUES (1968243347490783233, '00000', 'admin', '127.0.0.1', '内网IP', 'MSEdge', 'Windows 10 or Windows Server 2016', '0', '登录成功', '2025-09-17 17:19:17');
INSERT INTO `sys_logininfor` VALUES (1996641772917366786, '00000', 'admin', '127.0.0.1', '内网IP', 'MSEdge', 'Windows 10 or Windows Server 2016', '0', '登录成功', '2025-12-05 02:04:29');
INSERT INTO `sys_logininfor` VALUES (1997609592334340097, '00000', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'OSX', '0', '登录成功', '2025-12-07 18:10:15');
INSERT INTO `sys_logininfor` VALUES (1997697532678942722, '00000', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'OSX', '0', '登录成功', '2025-12-07 23:59:42');
INSERT INTO `sys_logininfor` VALUES (1998039211612246017, '00000', 'admin', '127.0.0.1', '内网IP', 'MSEdge', 'Windows 10 or Windows Server 2016', '0', '登录成功', '2025-12-08 22:37:24');
INSERT INTO `sys_logininfor` VALUES (2012926512864075778, '00000', 'admin', '127.0.0.1', '内网IP', 'MSEdge', 'OSX', '0', '登录成功', '2026-01-19 00:34:14');
INSERT INTO `sys_logininfor` VALUES (2028052145234935810, '00000', 'admin', '127.0.0.1', '内网IP', 'MSEdge', 'Windows 10 or Windows Server 2016', '0', '登录成功', '2026-03-01 18:18:05');
...
INSERT INTO `sys_role` VALUES (1729685491108446210, '911866', '管理员', 'admin', 4, '1', 1, 1, '0', '0', 103, 1, '2023-11-29 10:15:32', 1, '2025-05-23 14:10:49', '');
...
-- ----------------------------
-- Table structure for ya_album
-- ----------------------------
DROP TABLE IF EXISTS `ya_album`;
CREATE TABLE `ya_album`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '纪念册 id',
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '纪念册名称',
  `des` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '纪念册名称',
  `user_id` int NOT NULL COMMENT '创建者 ID',
  `template_id` int NOT NULL COMMENT '主题 id',
  `status` tinyint NOT NULL DEFAULT 0 COMMENT '状态 0 草稿 1发布',
  `is_public` tinyint NOT NULL DEFAULT 0 COMMENT '是否公开放在首页',
  `pdf_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '生成 PDF 的 ossURL',
...
-- ----------------------------
-- Table structure for ya_album_media
-- ----------------------------
DROP TABLE IF EXISTS `ya_album_media`;
CREATE TABLE `ya_album_media`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '上传的文件 id',
  `album_id` int NOT NULL COMMENT '关联的纪念册 id',
  `token_id` int NULL DEFAULT NULL COMMENT '匿名上传人id',
  `type` tinyint NOT NULL COMMENT '类型（1 文本 2 图片）',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '内容（文本为文本内容  图片为ossurl）',
  `sort` tinyint NULL DEFAULT NULL COMMENT '排序',
  `size` double NULL DEFAULT NULL COMMENT '文件大小 MB 为单位',
  `faces_count` int NULL DEFAULT NULL COMMENT 'ai 识别到的人脸数量',
  `tags` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT 'ai 分组的标签',
  `status` tinyint NOT NULL COMMENT '状态 -1 审核不通过 0 待审核 1 审核中 2 审核通过',
  `create_at` datetime NOT NULL,
...
-- ----------------------------
-- Records of ya_album_media
-- ----------------------------

-- ----------------------------
-- Table structure for ya_album_page
-- ----------------------------
DROP TABLE IF EXISTS `ya_album_page`;
CREATE TABLE `ya_album_page`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '页面 id',
  `album_id` int NOT NULL COMMENT '关联的纪念册 id',
  `template_page_id` int NOT NULL COMMENT '模板 id',
  `des` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '页面描述',
  `sort` tinyint NOT NULL COMMENT '页面排序',
  `data` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '实际填充的 json',
  `create_at` datetime NOT NULL,
  `update_at` datetime NOT NULL,
  `is_delete` tinyint NOT NULL COMMENT '删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ya_album_page
-- ----------------------------

-- ----------------------------
-- Table structure for ya_invite
-- ----------------------------
DROP TABLE IF EXISTS `ya_invite`;
CREATE TABLE `ya_invite`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '分享 id',
  `album_id` int NOT NULL COMMENT '纪念册 id',
  `invite_code` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '随机生成邀请码 6 位随机串',
  `access_code` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '访问码',
...
-- ----------------------------
-- Records of ya_invite
-- ----------------------------

-- ----------------------------
-- Table structure for ya_invite_token
-- ----------------------------
DROP TABLE IF EXISTS `ya_invite_token`;
CREATE TABLE `ya_invite_token`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '其实就是一个虚拟用户 的 id',
  `album_id` int NOT NULL COMMENT '纪念册 id',
  `invite_id` int NOT NULL COMMENT '邀请 id',
  ...
  `create_at` datetime NOT NULL,
  `expired_at` datetime NOT NULL COMMENT '过期时间 放 redis 中',
  `status` tinyint NOT NULL COMMENT '状态 0 已过期 1 可用',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ya_invite_token
-- ----------------------------

-- ----------------------------
-- Table structure for ya_template
-- ----------------------------
DROP TABLE IF EXISTS `ya_template`;
CREATE TABLE `ya_template`  (
  ...
  `type` int NOT NULL COMMENT '模板类型  存字典',
  `preview_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '预览图片 url',
  `des` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '描述（给ai看的）',
...
-- ----------------------------
-- Records of ya_template
-- ----------------------------

-- ----------------------------
-- Table structure for ya_template_page
-- ----------------------------
DROP TABLE IF EXISTS `ya_template_page`;
CREATE TABLE `ya_template_page`  (
  `template_page_id` int NOT NULL AUTO_INCREMENT COMMENT '模板页id',
  `template_id` int NOT NULL COMMENT '关联模板id',
  `template_schema_id` int NOT NULL COMMENT '关联的schema id',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '模板h5字符串',
  `preview_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '单页预览链接',
  ...
  `is_delete` int NOT NULL COMMENT '逻辑删除字段',
  PRIMARY KEY (`template_page_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ya_template_page
-- ----------------------------

-- ----------------------------
-- Table structure for ya_template_schema
-- ----------------------------
DROP TABLE IF EXISTS `ya_template_schema`;
CREATE TABLE `ya_template_schema`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'schemaid',
...
CREATE TABLE `ya_user`  (
  ...
  `password_hash` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '加密的密码',
  ...
  `is_delete` tinyint NOT NULL COMMENT '逻辑删除字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
